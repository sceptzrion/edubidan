...
export function LecturerProfileTab() {
  ...
  const [fullName, setFullName] = useState("Dr. Rina Hartati, S.ST., M.Keb");
  const [nidn, setNidn] = useState("0312087701");
    ...
    <div className="animate-in fade-in duration-300">
      <div className="mb-6">
        ...
        <p className="text-xs sm:text-sm text-muted-foreground font-medium leading-relaxed">
          Perbarui identitas dosen dan informasi kontak yang digunakan pada akun
          Anda.
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit}>
        <div className="flex flex-col items-center sm:flex-row sm:items-center gap-4 sm:gap-6 mb-8">
          <div className="relative shrink-0 w-fit">
            <div className="w-20 h-20 sm:w-24 sm:h-24 rounded-full bg-linear-to-br from-primary to-teal-500 flex items-center justify-center text-white text-2xl sm:text-3xl font-extrabold shadow-sm overflow-hidden">
              {avatarUrl ? (
                <img
                  src={avatarUrl}
