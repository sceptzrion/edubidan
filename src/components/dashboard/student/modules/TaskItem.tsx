...
export function TaskItem({ item, onClick }: TaskItemProps) {
  return (
    <div 
      onClick={onClick}
      // REVISI: p-5 jadi p-3 untuk HP, gap-4 jadi gap-3
    ...
    >
      <div className="flex items-center gap-3 sm:gap-4 flex-1 min-w-0">
        {/* REVISI: Ukuran kotak icon dan icon lucide di dalamnya dikecilkan untuk HP */}
        ...
        <div className="flex-1 min-w-0">
          {/* REVISI: Teks judul jadi text-sm di HP */}
      ...
      <div className="sm:ml-auto pt-2 sm:pt-0 border-t sm:border-0 border-border/50 shrink-0">
        {item.isCompleted ? (
           // REVISI: Badge Selesai dikecilkan text dan padding-nya di HP
          ...
          // REVISI: Tombol Mulai dirampingkan di HP
